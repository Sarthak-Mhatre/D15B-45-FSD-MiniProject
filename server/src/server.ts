...
// MongoDB connection (only if needed elsewhere; safe to keep for future)
...
// Passport/session needed for Google OAuth flow only
app.use(session({
...
// Auth routes (handle Google login, JWT issuance, profile, etc.)
app.use(authRoutes);
